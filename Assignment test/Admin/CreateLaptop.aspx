<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="CreateLaptop.aspx.cs" Inherits="WebApplication1.Admin.CreateLaptop" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="server">
    <div>
        <h1 style="margin-bottom: 0px">Create Laptop</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Main" runat="server">
    <form id="form1" runat="server">
        <div class="additional-formaction">
            <a href="ViewLaptop.aspx"><button id="Button1" class="btn btn-primary">Back</button></a>
