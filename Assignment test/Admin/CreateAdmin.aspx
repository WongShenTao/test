<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="CreateAdmin.aspx.cs" Inherits="WebApplication1.Admin.CreateAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Title" ContentPlaceHolderID="HeaderContent" runat="server">
    <div>
                        <h1 style="margin-bottom: 0px">Create Admin</h1>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <form id="form1" runat="server">
        ...
        <div class="formdiv">
            ...
            <div class="additional-formaction">
            <asp:Button ID="CreateAdminBtn" Style="padding:6px 12px"  runat="server" Text="Create" class="btn btn-primary"  />
