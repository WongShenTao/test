<%@ Page Title="" Language="C#" MasterPageFile="~/Laptop.Master" AutoEventWireup="true" CodeBehind="EditCartProduct.aspx.cs" Inherits="Assignment_test.WebForm9" %>
                            ...
                            <div class="product-right">
                                ...
                                <div class="product-buttons">
                                    ...
                                    <%--      <a href="#" onclick="addToCart(event)" id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                        <i class="fa fa-shopping-cart me-1" aria-hidden="true"></i>Confirm To Buy
                                    </a>--%>

                                    <asp:Button ID="Btnsubmit" OnClick="Btnsubmit_Click" CssClass="btn btn-solid hover-solid btn-animation" runat="server" Text="Confirm To Buy"></asp:Button>
                                    <%--     <a href="#" onclick="" class="btn btn-solid">
                                        <i class="fa fa-bookmark fz-16 me-2" aria-hidden="true"></i>wishlist
                                    </a>--%>

                                    <asp:HyperLink ID="HyperLink1" CssClass="btn btn-solid hover-solid btn-animation" runat="server" NavigateUrl="WebPages/MyCart.aspx">Back to Cart</asp:HyperLink>
    ...
    <script>
        function addToCart(event) {
            ...
            Swal.fire({
                icon: 'success',
                /*title: 'Added to Cart',*/
                title: '<h2 style="color: black">Updated The Option</h2>',
